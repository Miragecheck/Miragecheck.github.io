...
try {
  ...
  $mail->Username   = 'pridetech23@yandex.ru'; // Логин на почте
  $mail->Password   = 'iiwfrjyrnbfrbfrx'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('pridetech23@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('pridetech23@yandex.ru');
